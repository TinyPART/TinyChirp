...
from CNNModels import AudioClassifierCNNNoRelu
...
if __name__ =='__main__':
    model = AudioClassifierCNNNoRelu()
    model.load_state_dict(torch.load("model.cnn.59.0.941964328289032.pth",map_location="cpu"))
